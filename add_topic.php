  ...
  <a href="add_topic.php"><li style="background: #555;">
    ...
    <form  method="POST">
     ...
     <select name="top" style="padding: 5px 4px;color:grey;border:solid; ">
     	<option value="1">Foundation, Design & Creativity Track</option>
     	<option value="2">Technical & Digital Tools Track</option>
     	<option value="2">Professional Practice Track</option>
     	<option value="1">Specializations & Capstone Projects</option>
     </select>
