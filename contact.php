	...
	<div class="container">
		<div class="contact-main">
			...
			<div class="contact-block1">
			 	...
			 	<ul>
			    	<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span><p>Administrator E-learning at SIGNET</p></li>
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>8905825409</p></li>
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:signet@gmail.com">signet@gmail.com</a></p></li>
			    </ul>
			 	</div>
